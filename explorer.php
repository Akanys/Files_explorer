...
$IMGFOLDER='img/closefiles.png'; /*L'icon pour le dossier*/
$IMGFILE='img/document.png'; /*Icon pour le fichier*/
$IMGCREATEFILE='img/document.png'; /*Fichier pour crée un fichier*/
$IMGUPLOAD='img/download.png'; /*Fichier pour upload des fichier*/
$IMGCREATEFOLDER='img/newfiles.png';
  ...
  <div id="header" class="container">
    <div class="row justify-content-center">                                                          
        <div class="col-2 col-md-1 nopadding">
          <a href="#" class="icone" target="_blank">
          <img src="img/return.png" alt="button return" width="50px" /></a>
        </div>
        <div class="col-2 col-md-1 nopadding">  
          <a href="#" class="icone" target="_blank">
          <img src="img/update.png" alt="button update" width="50px"/> </a>
        </div>
        <div class="col-2 col-md-1 nopadding">
          <a href="#" class="icone" onclick="display_('mkdir');"><img alt="button newfiles" width="50px" title="Cree un dossier" src="<?php echo $IMGCREATEFOLDER; ?>" /></a> 
        </div>
        <div class="col-2 col-md-1 nopadding">
          <a href="#" class="icone" onclick="display_('upload');"><img alt="button Download" width="50px" title="Telecharger un fichier" src="<?php echo $IMGUPLOAD; ?>" /></a>       
        </div>
        <div class="col-2 col-md-1 nopadding">
...
while ($f = readdir($handle)) { //Boucle qui enumere tout les fichier d'un repertoire
  ...
  if(@is_dir($rep.'/'.$f)){ /*verifie si c'est un repertoire*/
     ...
     echo '<a href="?dir='.$replien.'/'.$lien.'"><img alt="Dossier" src="'.$IMGFOLDER.'" />'.$f.'</a><br />'; 
	  ...
	  echo '<img src="'.$IMGFILE.'" width="50px" alt="Fichier"/>'.$f.'<a href="?delete='.$replien.'/'.$lien.'" onclick="return confirm(\'Supprimer '.$f.' ?\');"><img alt="Supprimer" width="30px" title="/!\Supprimer/!\ " src="img/garbage.png" /></a><a href="?download='.$replien.'/'.$lien.'" ><img alt="Telecharger" width="30px" title="Telecharger " src="img/download.png" /></a><br />';
}
